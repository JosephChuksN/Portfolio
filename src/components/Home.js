...
const icons = sociails.map(icons =>{
    ...
    return(
        ...
        <div className="text-gray-50 p-4 mb-20 mt-32">
            ...
            <p className="text-xl text-gray-50 font-thin text-sm w-full tracking-tighter text-justify mb-5 ">I build and create proficient website,
