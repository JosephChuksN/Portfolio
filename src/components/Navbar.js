   ...
   const links = [
    ...
    return(
        ...
        <div className="p-2 lg:flex items-center z-[-1] justify-between space-y-3">
         ...
         <ul onClick={handleToggle} className={`lg:items-center   lg:justify-center lg:shadow-0 lg:z-auto lg:pb-0 lg:w-auto lg:static  lg:flex bg-gray-900/95 w-full left-0 lg:justify-center  z-[-1]  absolute lg:space-x-10 pb-6 pt-4 space-y-4 ${show ? "top-10  shadow-md" : "top-[-490px]"} duration-300 transition-all ease-in`}>
           {
             links.map(tags => (
